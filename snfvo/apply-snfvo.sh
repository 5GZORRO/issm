...
python3 ./cli.py --file ./spectrum-slice.yaml --service_owner operator-c --issm_api_url http://172.28.3.15:30080 --snfvo_name "Slice offer with configurable spectrum" --product_offer_id f5bfa01e-83e5-4c29-9860-1efd36aa189c
...
python3 ./cli.py --file ./optimizer.yaml --service_owner operator-c --issm_api_url http://172.28.3.15:30080 --snfvo_name "Optimized Service (e2e test of ISSM-O)" --product_offer_id 416767e2-cd33-4b62-b2d5-074aaa156004
