...
Data payload:
    ...
    intent             - the intent to be submitted (json)
        requested_price  - price of the slice/resource (range e.g. "1200-1400")
...
```
curl -H "Content-type: application/json" -POST -d '{"service_owner": "operator-a", "intent": {"requested_price": "1200-1400", "latitude": "24", "longitude": "45", "slice_segment": "edge", "category": "CDN", "qos_parameters": {"bandwidth": "30"} }}' http://172.28.3.42:30080/instantiate
